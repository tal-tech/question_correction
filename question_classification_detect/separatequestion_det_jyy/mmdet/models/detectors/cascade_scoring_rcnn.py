...
class CascadeScoringRCNN(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeScoringRCNN, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(CascadeScoringRCNN, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(CascadeScoringRCNN, self).show_result(data, result, **kwargs)
