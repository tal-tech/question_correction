...
bool Init() {
	...
	encoder_model_path3_ = "./formula/model/optimized_batch6_rec_formula_recognization_encoder_v1.0.0.pt";
	...
	decoder_model_path3_ = "./formula/model/optimized_batch6_rec_formula_recognization_decoder_v1.0.3.pt";

	config_path1_        = "./formula/model/config_v1.0.1.ini";
	config_path2_        = "./formula/model/config_v1.0.2.ini";
	config_path3_        = "./formula/model/config_v1.0.0.ini";
	...
	word_dict_path3_     = "./formula/model/rec_formula_recognization_words_v1.0.0.txt";
...
int main(){
	...
	result3 = ModelFunc(image,p_detector3_.get());
